...
import { fetchCategoryJewellery } from './categoriesSlice'
...
const CategoryJewel = () => {
    ...
    useEffect(()=>{
        dispatch(fetchCategoryJewellery());
    },[]);
    ...
    return (
        <>  
               <div className="container-fluid">
                  <div className='mx-5 my-5'> <h2 className='pro-head py-3'>Shopper's Corner Jewellery Collection</h2>
