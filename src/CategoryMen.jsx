...
import { fetchCategoryMen } from './categoriesSlice'
...
return (
    <>   
           <div className="container-fluid">
              <div className='mx-5 my-5'> <h2 className='pro-head py-3'>Namaste Autunm Collection</h2>
            <p>Our most popular products for men. Updated frequently.</p>  </div>
