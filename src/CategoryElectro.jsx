...
import { fetchCategoryElectronics } from './categoriesSlice'
...
const CategoryElectro = () => {
    ...
    useEffect(()=>{
        dispatch(fetchCategoryElectronics());
    },[]);
  ...
  return (
    <>
           ...
           <div className="container-fluid">
              ...
              <div className='mx-5 my-5'> <h2 className='pro-head py-3'>Shopper's Corner Electronics Collection</h2>
...
export default CategoryElectro;